...
package body main is
  ...
  g_prog : Shader_Program;
  g_quad : access Full_Screen_Quad;
  ...
  begin
    ...
    g_prog := Create_Shader_Program("../main/Vertex.vert", "../main/Fragment.frag");
    g_quad := new Full_Screen_Quad;
  ...
  begin
    ...
    -- due to Full_Screen_Quad is 'limited', Ada will automaticly call destructor when reference leaves it's scope
    -- Free(g_quad);
